...
if __name__ == "__main__":
    ...
    query1 = 'timhortons OR Tim Hortons OR TimHortons lang:en' # tweets containing the word 'Tim Hortons'
    # query2 = 'Tim Hortons'  # tweets containing 'Tim Horton' and 'Tim Horton' at the same time
    ...
    recent_result1 = tc.fetch_recent_tweets(query=query1  # search query
                            , tweets_cnt= 20000  # number of tweets to collect
                            ...
                            , file_name = 'TimHortons.json'  # this will be the file name
                            )
    ...
    #                         , save_result= True # if True, the result will be atomatically saved to a json file in the current directory for later analysis
    #                         , save_dir = 'sample_data'  # the file will be saved in this directory
    #                         , file_name = 'Tim Hortons.json'  # this will be the file name
    #                         )
    ...
    #                         , save_result= True # if True, the result will be atomatically saved to a json file in the current directory for later analysis
    #                         , start_time = datetime.fromisoformat('2022-09-25 14:00:00')  # starting time for tweet collection, must be within 7 days
    #                         , end_time = datetime.fromisoformat('2022-09-29 18:00:00')  # ending time for tweet collection, must be within 7 days
    #                         , save_dir = 'sample_data'  # the file will be saved in this directory
    #                         , file_name = 'Tim Hortons.json'  # this will be the file name
    #                         )
    ...
    # streaming_result = tc.fetch_stream_tweets(query = query1  # search query
